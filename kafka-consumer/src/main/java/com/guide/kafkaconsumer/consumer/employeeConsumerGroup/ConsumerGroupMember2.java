...
public class ConsumerGroupMember2 {
    ...
    public void listen(String employee,
        ...
        logger.info("consuming from ConsumerGroupMember2 {} key-> {} partitionNumber-> {} topicName-> {} timeStamp-> {}", employee, key, partition, topic, ts);
    }
}
