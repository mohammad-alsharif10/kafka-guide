...
public class ConsumerGroupMember3 {
    ...
    public void listen(String employee,
        ...
        logger.info("consuming from ConsumerGroupMember3 {} key-> {} partitionNumber-> {} topicName-> {} timeStamp-> {}", employee, key, partition, topic, ts);
    }
}
